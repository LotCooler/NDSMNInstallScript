...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='NDS.conf'
CONFIGFOLDER='/root/.NDS'
COIN_DAEMON='NDSd'
COIN_CLI='NDS-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`https://github.com/NDScoin/nds/releases/download/NDSv1.0/NDS-1.0.0-x86_64-linux.tar`
COIN_ZIP=`https://github.com/NDScoin/nds/releases/download/NDSv1.0/NDS-1.0.0-x86_64-linux.tar`
COIN_NAME='NDS'
COIN_PORT=19444
RPC_PORT=19443
